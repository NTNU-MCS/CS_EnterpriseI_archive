...
// constexpr uint16_t ALL_LED_ON_L = 0xFA;         /**< load all the LEDn_ON registers, low */
// constexpr uint16_t ALL_LED_ON_H  = 0xFB;         /**< load all the LEDn_ON registers, high */
// constexpr uint16_t ALL_LED_OFF_L = 0xFC;        /**< load all the LEDn_OFF registers, low */
// constexpr uint16_t ALL_LED_OFF_H = 0xFD;       /**< load all the LEDn_OFF registers,high */
// constexpr uint16_t PRESCALE = 0xFE;             /**< Prescaler for PWM output frequency */
// constexpr uint16_t PCA9685_TESTMODE = 0xFF;     /**< defines the test mode to be entered */

// // MODE1 bits
// constexpr uint16_t MODE1_ALLCAL = 0x01;  /**< respond to LED All Call I2C-bus address */
// constexpr uint16_t MODE1_SUB3  = 0x02;    /**< respond to I2C-bus subaddress 3 */
// constexpr uint16_t MODE1_SUB2 = 0x04;    /**< respond to I2C-bus subaddress 2 */
// constexpr uint16_t MODE1_SUB1 = 0x08;    /**< respond to I2C-bus subaddress 1 */
// constexpr uint16_t SLEEP = 0x10;         /**< Low power mode. Oscillator off */
// constexpr uint16_t MODE1_AI = 0x20;      /**< Auto-Increment enabled */
// constexpr uint16_t MODE1_EXTCLK = 0x40;  /**< Use EXTCLK pin clock */
// constexpr uint16_t RESTART = 0x80;       /**< Restart enabled */
// // MODE2 bits
// constexpr uint16_t MODE2_OUTNE_0 = 0x01; /**< Active LOW output enable input */
// constexpr uint16_t MODE2_OUTNE_1 = 0x02;                  /**< Active LOW output enable input - high impedience */
// constexpr uint16_t MODE2_OUTDRV = 0x04l /**< totem pole structure vs open-drain */
// constexpr uint16_t MODE2_OCH = 0x08;    /**< Outputs change on ACK vs STOP */
// constexpr uint16_t MODE2_INVRT = 0x10;  /**< Output logic state inverted */

// constexpr uint16_t PCA9685_I2C_ADDRESS = 0x40;      /**< Default PCA9685 I2C Slave Address */
// constexpr uint16_t FREQUENCY_OSCILLATOR = 25000000; /**< Int. osc. frequency in datasheet */
